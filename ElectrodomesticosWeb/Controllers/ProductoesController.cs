...
namespace ElectrodomesticosWeb.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,CategoriaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,CategoriaId")] Producto producto)
        {
            if (ModelState.IsValid)
            {
