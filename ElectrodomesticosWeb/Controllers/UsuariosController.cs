...
namespace ElectrodomesticosWeb.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreUsuario,Password")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreUsuario,Password")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
